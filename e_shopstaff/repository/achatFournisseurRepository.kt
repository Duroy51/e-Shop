...
interface achatFournisseurRepository {

    fun getAllAchatFournisseurStream(): Flow<List<achatFournisseur>>

    /**
     * Retrieve an item from the given data source that matches with the [id].
     */
    fun getAchatFournisseurStream(id: Int): Flow<achatFournisseur?>
